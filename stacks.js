...
function cardToDiv(i, props) {
    if (i >= 510) {
        ...
        return <div style={({display: "inline-block", width: "605px"})} key={"cardToDiv-div-" + i}>
            <img key={i}
                 src={"https://raw.githubusercontent.com/any2cards/gloomhaven/master/images/personal-goals/pg-" + i + ".png"}/>
        </div>;
    } else {
...
class EventCard extends React.Component {
    ...
    render() {
        ...
        let r = [
            ...
            <div key="div-a">
                <button key="a" type="button" onClick={this.selectA}
                        className={this.state.selected === "a" ? "selected" : ""}>A
                </button>
            </div>,
            <div key="div-b">
                <button key="b" type="button" onClick={this.selectB}
                        className={this.state.selected === "b" ? "selected" : ""}>B
                </button>
            </div>,
        ];
        ...
        return [
            ...
            <div key="button-div">
                {this.props.drawnCards.map(cardNo => {
                    return <div key={"span-" + cardNo} style={({
                        display: "inline-block",
                        width: this.props.cardProps && this.props.cardProps.divWidth
                    })}>
                        <div key={"button-div-" + cardNo}>
                            <button key={"button-" + cardNo} type="button"
                                    onClick={() => this.clicked(cardNo)}>Accept {cardNo}</button>
                        </div>
...
class Draw extends React.Component {
    ...
    render() {
        return <button type="button" onClick={this.clicked}
                       disabled={this.props.cards.stack.length === 0}>{"Draw " + this.props.name}</button>
    }
}
...
class Pop extends React.Component {
    ...
    render() {
        return <button type="button" onClick={this.clicked}
                       disabled={this.props.cards.stack.length === 0}>{"Draw " + this.props.name + " Event"}</button>
    }
}
...
class ImportExport extends React.Component {
    ...
    render() {
        ...
        return [
            ...
            <button key="from-clipboard" type="submit" onClick={this.importFromClipboard}>Import from
                Clipboard</button>,
    ...
    render() {
        return [
            <div key="button-frame" className="frame">
                <Pop key="city" name="City" cards={this.state.stacks.cityEvents} setDialog={this.setDialog}
                     stackPopped={this.stackPopped}/>
                <Pop key="road" name="Road" cards={this.state.stacks.roadEvents} setDialog={this.setDialog}
                     stackPopped={this.stackPopped}/>
                <Draw key="randomItem" name="Random Item Design" cards={this.state.stacks.randomItemDesigns}
                      cardProps={randomItemDesigns} setDialog={this.setDialog} drawn={this.stackDrawn}/>
                <Draw key="randomScenario" name="Random Side Scenario" cards={this.state.stacks.randomScenarios}
                      setDialog={this.setDialog} drawn={this.stackDrawn}/>
                <Draw key="personalGoal" name="Personal Goal" n={2} cards={this.state.stacks.personalGoals}
                      cardProps={personalGoals} setDialog={this.setDialog} drawn={this.stackDrawn}/>
