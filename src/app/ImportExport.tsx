...
export class ImportExport extends React.Component<ImportExportProps, ImportExportState> {
  ...
  copyToClipboard() {
    navigator
      .clipboard!.writeText(this.stacksToJsonString())
  ...
  render() {
    return (
      <React.Fragment>
        ...
        <button
          key="to-clipboard"
          hidden={!ImportExport.supportForCopyToClipboard()}
          type="submit"
        ...
        <button
          key="from-clipboard"
          hidden={!ImportExport.supportForImportFromClipboard()}
          type="submit"
          onClick={this.importFromClipboard}
        >
          Import from Clipboard
        </button>
        <button key="import" type="submit" onClick={this.importClicked}>
          {'Import'}
        </button>
        <button key="cancel" type="submit" onClick={this.props.cancel}>
          {'Cancel'}
        </button>
      </React.Fragment>
    )
